...
('한화생명',        2, 'CONTAINS', 100),
('교보생명',        2, 'CONTAINS', 100),
('DB손해보험',      2, 'CONTAINS', 100),
('메리츠화재',      2, 'CONTAINS', 100),
('현대해상',        2, 'CONTAINS', 100),
('KB손해보험',      2, 'CONTAINS', 100),
('흥국화재',        2, 'CONTAINS', 100),
('동양생명',        2, 'CONTAINS', 100),
('ABL생명',         2, 'CONTAINS', 100),
('라이나생명',      2, 'CONTAINS', 100),
('신한생명',        2, 'CONTAINS', 100),
('롯데손해보험',    2, 'CONTAINS', 100),
('하나생명',        2, 'CONTAINS', 100),
('생명보험',        2, 'CONTAINS', 95),
('손해보험',        2, 'CONTAINS', 95),
('화재보험',        2, 'CONTAINS', 90),
...
('SKT',             3, 'EXACT',   100),
('KT',              3, 'EXACT',   100),
('LG유플러스',      3, 'CONTAINS', 100),
('LGU+',            3, 'EXACT',   100),
('SK브로드밴드',    3, 'CONTAINS', 100),
('SK텔레콤',        3, 'CONTAINS', 100),
('KT인터넷',        3, 'CONTAINS', 90),
('U+인터넷',        3, 'CONTAINS', 90),
('알뜰폰',          3, 'CONTAINS', 85),
...
('공차',            5, 'EXACT',    100),
('더벤티',          5, 'CONTAINS', 100),
('컴포즈커피',      5, 'CONTAINS', 100),
('카페베네',        5, 'CONTAINS', 100),
('파스쿠찌',        5, 'CONTAINS', 100),
('엔제리너스',      5, 'CONTAINS', 100),
('드롭탑',          5, 'CONTAINS', 100),
('쥬씨',            5, 'EXACT',    100),
...
('버거킹',          5, 'CONTAINS', 100),
('KFC',             5, 'CONTAINS', 100),
('노브랜드버거',    5, 'CONTAINS', 100),
('맘스터치',        5, 'CONTAINS', 100),
('서브웨이',        5, 'CONTAINS', 100),
('도미노피자',      5, 'CONTAINS', 100),
('피자헛',          5, 'CONTAINS', 100),
('파파존스',        5, 'CONTAINS', 100),
('피자알볼로',      5, 'CONTAINS', 100),
('피자',      5, 'CONTAINS',   95),
('치킨',      5, 'CONTAINS',   95),
('BBQ',             5, 'CONTAINS',   95),
('굽네치킨',        5, 'CONTAINS', 100),
('교촌치킨',        5, 'CONTAINS', 100),
('BBQ치킨',         5, 'CONTAINS', 100),
('BHC',             5, 'CONTAINS', 100),
('처갓집양념치킨',  5, 'CONTAINS', 100),
('네네치킨',        5, 'CONTAINS', 100),
('60계치킨',        5, 'CONTAINS', 100),
('깐부치킨',        5, 'CONTAINS', 100),
-- 편의점
('GS25',            5, 'CONTAINS',   95),
('CU',              5, 'CONTAINS',   95),
...
('한솥',            5, 'EXACT',    100),
('김밥천국',        5, 'CONTAINS',  90),
('반올림피자',      5, 'CONTAINS', 100),
('청년다방',        5, 'CONTAINS', 100),
('이삭토스트',      5, 'CONTAINS', 100),
('동대문엽기떡볶이', 5, 'CONTAINS', 100),
('떡볶이',         5, 'CONTAINS',   90),
('국밥',            5, 'CONTAINS', 75),
('냉면',            5, 'CONTAINS', 75),
('설렁탕',          5, 'CONTAINS', 75),
...
('스타벅스코리아',  5, 'CONTAINS', 100),  -- 법인명으로 찍히는 경우
('파리바게뜨',      5, 'CONTAINS', 100),  -- 베이커리 대표 브랜드
('뚜레쥬르',        5, 'CONTAINS', 100),
('배스킨라빈스',    5, 'CONTAINS', 100),
('던킨',            5, 'CONTAINS', 100),
('쉐이크쉑',        5, 'CONTAINS', 100),
('행복추풍령',      5, 'CONTAINS', 100),  -- 고속도로 휴게소 주요 운영사
...
-- 신선식품·이커머스 (생활용품 포함)
('마켓컬리',        6, 'CONTAINS', 100),
('오아시스마켓',    6, 'CONTAINS', 100),
('SSG닷컴',         6, 'CONTAINS', 100),
('오늘의집',        6, 'CONTAINS', 100),
('이케아',          6, 'CONTAINS', 100),
...
('씽씽',            7, 'EXACT',    100),
('따릉이',          7, 'CONTAINS', 100),
('카카오바이크',    7, 'CONTAINS', 100),
('일레클',          7, 'CONTAINS', 100),
('우버',            7, 'EXACT',    100),
('타다',            7, 'EXACT',    100),
('아이엠택시',      7, 'CONTAINS', 100),
('UT',              7, 'EXACT',    100),  -- 우버택시 앱
('국토교통부',      7, 'CONTAINS', 80),  -- 하이패스 충전
('한국도로공사',    7, 'CONTAINS', 80),  -- 하이패스·통행료
-- 주유소
('SK에너지',        7, 'CONTAINS', 100),
('GS칼텍스',        7, 'CONTAINS', 100),
('현대오일뱅크',    7, 'CONTAINS', 100),
('S-OIL',           7, 'EXACT',    100),
('에쓰오일',        7, 'CONTAINS', 100),
('알뜰주유소',      7, 'CONTAINS',  85),
-- 고속버스·철도
...
('MLB',             8, 'EXACT',    100),
('빈폴',            8, 'EXACT',    100),
('캘빈클라인',      8, 'CONTAINS', 100),
('코오롱스포츠',    8, 'CONTAINS', 100),
('노스페이스',      8, 'CONTAINS', 100),
('네파',            8, 'EXACT',    100),
('K2',              8, 'EXACT',   100),
...
-- OTT
('넷플릭스',        9, 'CONTAINS', 100),
('NETFLIX',        9, 'CONTAINS', 100),
('유튜브프리미엄',  9, 'CONTAINS', 100),
('왓챠',            9, 'EXACT',    100),
('웨이브',          9, 'CONTAINS', 100),
('티빙',            9, 'EXACT',    100),
('디즈니플러스',    9, 'CONTAINS', 100),
('애플TV',          9, 'CONTAINS', 100),
...
('야놀자',          9, 'CONTAINS', 100),
('여기어때',        9, 'CONTAINS', 100),
('에어비앤비',      9, 'CONTAINS', 100),
('호텔스닷컴',      9, 'CONTAINS', 100),
('아고다',          9, 'CONTAINS', 100),
('부킹닷컴',        9, 'CONTAINS', 100),
('호텔',            9, 'CONTAINS', 80),
('모텔',            9, 'CONTAINS', 80),
...
-- 영화관
('CGV',             9, 'CONTAINS', 100),
('롯데시네마',      9, 'CONTAINS', 100),
('메가박스',        9, 'CONTAINS', 100),
-- 게임
('스팀',            9, 'EXACT',    100),
('넥슨',            9, 'EXACT',    100),
('엔씨소프트',      9, 'CONTAINS', 100),
('카카오게임즈',    9, 'CONTAINS', 100),
('넷마블',          9, 'CONTAINS', 100),
('게임',            9, 'CONTAINS', 70),
-- 스포츠·레저
('스포츠',      9, 'CONTAINS', 85),
...
('영풍문고',        9, 'CONTAINS',   90),
('리디',            9, 'CONTAINS',  90),
('반디앤루니스',    9, 'CONTAINS', 100),
('밀리의서재',      9, 'CONTAINS', 100),
-- 미용
('헤어', 9, 'CONTAINS', 90),
('미용실', 9, 'CONTAINS', 90),
...
-- 쿠팡: 식품·생활용품 혼재로 카테고리 특정 불가 → 기타지출 유지, 사용자 수동 수정 유도
-- ============================================================
INSERT IGNORE INTO merchant_category_rule (keyword, category_id, match_type, priority) VALUES
...
('쿠팡',           11, 'CONTAINS', 75); -- 식품·생활 혼재, 쿠팡이츠는 별도 처리
